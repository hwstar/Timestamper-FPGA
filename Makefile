...
PROJECT := root_lattice
TESTBENCH := testbench.v
DEVICE := 1k


SOURCES = $(PROJECT).v system.v counter.v channel.v dpram.v ptrfifo.v mux64to8.v utx.v
...
dsn: $(TESTBENCH) $(SOURCES)
	@-killall gtkwave 2>/dev/null
	iverilog -o dsn $(TESTBENCH) $(SOURCES)
